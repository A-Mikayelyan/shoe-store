    ...
    <div className="shipping-step">
      ...
      <form className="shipping-form" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <input name="address1" type="text" required value={formData.address1} onChange={handleChange} />
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            <input name="zip" type="text" required value={formData.zip} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label>* City</label>
        ...
        <div className="form-group">
          ...
          <input name="courierInfo" type="text" value={formData.courierInfo} onChange={handleChange} />
        </div>

        <button className="continue-btn" type="submit" onClick={handleSubmit}>
          PROCEED TO PAYMENT
        </button>
      </form>
